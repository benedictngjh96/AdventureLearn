...
public class PlayGames extends Godot.SingletonBase {
    ...
    public void google_init(final int id){
     ...
     // GoogleSignInOptions signInOptions = GoogleSignInOptions.DEFAULT_GAMES_SIGN_IN;
	  GoogleSignInOptions signInOptions = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN).requestId().requestProfile().requestEmail().build();
	...
	public boolean checkStatus(){
		if (mAccount != null){
			Log.d(TAG,"Acc alraeady logined");
			return true;
		}
		else{
			return false;
        ...
        registerClass("PlayGames", new String[]
            {
                ...
                "leaderShow","leaderSubmit","leaderShowList","getId","getEmail","getName","checkStatus"
            });
        activity = p_activity;
